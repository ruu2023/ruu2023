...
- 新しい技術の探求と学習
- **主な関心技術:** Next.js, Vue.js, Rails
- モダンで効率的な開発手法
- 個人で使える便利なサービスを開発し、共有すること

## 🛠️ スキルセット (Skills)

- **Languages:** Java, PHP, Ruby, TypeScript
- **Frameworks/Libraries:** Springboot, Laravel, Vue.js, Next.js
...
- 個人向けの記事販売アプリケーションです。Next.js と Micro CMS を採用して Stripe にて決済します。
